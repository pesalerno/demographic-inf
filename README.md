...
Filtering the input SNP matrix
--------


First, I need to prep the input files for the program. In order to run a proper demographic analysis, we should have a filtered SNP matrix which excludes: 

- highly linked loci
- loci potentially under selection

> BELOW ARE UNEDITED STEPS FROM THE CHIMANTA WORKFLOW FOR SEPARATING PUTATIVELY ADAPTIVE AND NEUTRAL-ONLY DATASETS. 
